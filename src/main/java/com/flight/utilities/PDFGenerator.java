...
//	        }
	    ...
	    private static void addTitleAndTable(Document document,String name,String emailId,String phone,String operatingAirlines,PdfPCell departureDate,String departureCity,String arrivalCity)
	            throws DocumentException {
//	        Paragraph preface = new Paragraph();
//	        preface.add(new Paragraph("Flight Booking Details", catFont));
//	        
//	        preface.add(new Paragraph("Report generated by:"+"Flight Reservation Company"));
//	     
